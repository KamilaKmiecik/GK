...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    private float x=0,z=0;
		...
		// Change the ambient and diffuse colors to a golden yellow
	...
	public void Pyramid(GL2 gl2){
		...
		gl2.glMaterialfv (GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[10], 4);
		gl2.glMaterialf (GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[10][4]);
		gl2.glMaterialf (GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[10][8]);
	...
	public void init(GLAutoDrawable drawable) {
        ...
        // Set the ambient, diffuse, and specular light colors
